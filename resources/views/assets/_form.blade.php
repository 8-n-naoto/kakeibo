...
@if (($s ?? null) === null)
    <p class="text-xs text-slate-400 mt-3">※ 1ヶ月1件のスナップショットです。すでにある月を選んだときは、上書きの確認が出ます。</p>
@else
    <p class="text-xs text-slate-400 mt-3">※ 1ヶ月1件のスナップショットです。すでに記録がある月へは移せません（先にそちらを削除してください）。</p>
@endif
